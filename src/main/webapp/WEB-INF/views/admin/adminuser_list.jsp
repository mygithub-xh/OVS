        ...
        $(function() {
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function(){
                    ...
                    $("#edit_password").textbox('setValue', selectRow.psw);
                }
            });
...
<div id="addDialog" style="padding: 10px;">
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            ...
            <tr>
                <td>密码:</td>
                <td><input id="add_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="password" name="psw" data-options="required:true, missingMessage:'请填写密码'"  /></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        ...
        <table id="editTable" border=0 cellpadding="8" >
            ...
            <tr>
                <td>密码:</td>
                <td><input id="edit_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="password" name="psw" data-options="required:true, missingMessage:'请填写密码'"  /></td>
            </tr>
        </table>
    </form>
</div>
