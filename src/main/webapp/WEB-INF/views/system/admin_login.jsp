    ...
    <form id="form" class="form form-horizontal" method="post" >
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="username" name="loginname" value="" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="password" name="psw" value="" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright &nbsp; artisan @ 【xuhang】 </div>
